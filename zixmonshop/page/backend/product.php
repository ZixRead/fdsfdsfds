<div class="container-sm bg-white border border-2 mt-5 shadow-sm p-4 mb-4">
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-shopping-basket"></i>&nbsp;จัดการสินค้า</h1>
    </center>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-dark"><?php
                                                ...
                                                ?></td>
                        <td class="text-dark"><?php echo htmlspecialchars($row['c_type']); ?></td>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" id="p_type_product">
                                ...
                                <option value="0" selected>สุ่มรางวัล</option>
                    ...
                    <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select" id="type_product">
                                ...
                                <option id="type_unselected" value="0">Two</option>
                            </select>
                        </div>
                        <div class="mb-2">
                            <p class="text-secondary mb-1">หมวดหมู่สินค้า <span class="text-danger">*</span></p>
