<div class="container-sm bg-white border border-2 mt-5 shadow-sm p-4 mb-4">
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-shopping-basket"></i>&nbsp;จัดการหมวดหมู่</h1>
    </center>
    ...
    <div class="table-responsive mt-3 ">
        <table id="table" class="table mt-2">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="text-dark"><?php echo $row['c_id']; ?></td>
                        <td class="text-dark"><img src="<?php echo htmlspecialchars($row['img']); ?>" width="100px" alt=""></td>
                        <td class="text-dark"><?php echo htmlspecialchars($row['c_name']); ?></td>
                        <td class="text-dark"><?php echo htmlspecialchars($row['des']); ?></td>
                        <td><button class="btn btn-warning text-dark w-100" style="width : 130px!important" onclick="get_detail(<?php echo $row['c_id']; ?>)"><i class="fa-solid fa-pencil"></i>&nbsp;แก้ไข</button></td>
