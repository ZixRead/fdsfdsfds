<div class="container-sm border border-2 bg-white mt-5  shadow-sm p-4 mb-4">
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-users"></i>&nbsp;จัดการผู้ใช้</h1>
    </center>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-dark"><?php echo number_format($row['point']); ?></td>
                        <td class="text-dark"><?php echo htmlspecialchars($row['total']); ?></td>
                        <td class="text-white"><button class="btn btn-warning text-dark w-50" onclick="get_detail(<?php echo $row['id']; ?>)"><i class="fa-solid fa-pencil"></i>&nbsp;แก้ไข</button></td>
