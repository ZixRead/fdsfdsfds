<div class="container-sm  bg-white border border-2   mt-5 border-2 shadow-sm p-4 mb-4 rounded">
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-fire"></i>&nbsp;ตั้งค่าสินค้าแนะนำ</h1>
    </center>
    <hr class="mt-1 mb-1 border-secondary">
    <div class="col-lg-6 m-auto">
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #1 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #2 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #3 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #4 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #5 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #6 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #7 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #8 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #9 <span class="text-danger">*</span></p>
        ...
        <div class="mb-2 mt-4">
            <p class="m-0 text-dark">สินค้าแนะนำ #10 <span class="text-danger">*</span></p>
