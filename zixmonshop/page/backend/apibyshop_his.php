...
<div class="container-fluid ps-4 pe-4 bg-white border border-2 mt-5">
    <center class="m-0"><h2 class="text-main mb-2 mt-4"><i class="fa-regular fa-history"></i> ประวัติแอพพรีเมี่ยมทั้งหมด</h2></center>
    <hr class="mt-1">
