...
?>
<div class="container-sm bg-white border border-2 mt-5 border-2 shadow-sm p-4 mb-4" >
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-shopping-basket"></i>&nbsp;จัดการสต็อก</h1>
    </center>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class="text-dark"><?php echo htmlspecialchars($row['password']);?></td>
