<div class="container-sm bg-white border border-2  mt-5 shadow-sm p-4 mb-4" >
    <center>
        <h1 class="text-dark">&nbsp;<i class="fa-duotone fa-code"></i>&nbsp;จัดการโค้ด</h1>
    </center>
            ...
            <tbody>
                ...
                ?>
                    <tr >
                        ...
                        <td class="text-dark" ><?php echo htmlspecialchars($row['code']);?></td>
                        <td class="text-dark"><?php echo htmlspecialchars($row['prize']);?></td>
                        <td class="text-dark"><?php echo number_format($row['count']);?></td>
                        <td class="text-dark"><?php echo number_format($row['max_count']);?></td>
