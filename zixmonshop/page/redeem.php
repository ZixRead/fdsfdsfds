<div class="container-fluid p-4">
    <div class="container-sm  ps-4 pe-4">
        <div class="container-fluid border border-2 bg-white p-4">
            ...
            <h1 class="text-strongest text-dark" data-aos="fade-right" data-aos-duration="500"><i class="fa-duotone fa-code"></i> &nbsp;Redeem (กรอกโค้ด)</h1>
            <div data-aos="fade-right" data-aos-duration="600" >
                <hr class="mt-1 mb-2">
                <h5 class="text-main m-0"><i class="fa-regular fa-gift"></i>&nbsp;กรอกโค้ดเพื่อรับรางวัลจากเว็บของเรา</h5>
            </div>
            ...
            <button class="bg-main-gra btn mt-2 text-white w-100" id="redeem-btn" style="border-radius: 20px;" data-aos="fade-up" data-aos-duration="800">Redeem</button>
            </div>
        </div>
    </div>
</div>
